...
namespace Helix
{
    public static class HelixMeshEditor
    {
        ...
        static string NewFileName(Mesh mesh)
        {
            ...
            return AssetDatabase.GenerateUniqueAssetPath(
                path + "/Helix Converted.asset"
            );
        }

        [MenuItem("Assets/Helix/Convert Mesh", true)]
        static bool ValidateConvertMesh()
        {
            return SelectedMeshes.Length > 0;
        }

        [MenuItem("Assets/Helix/Convert Mesh")]
